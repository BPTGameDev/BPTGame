...
public class PlayfabManager : MonoBehaviour
{
    ...
    // this function doesn't work at this point(?)
    ...
    void OnIDUpdateSuccess(UpdateUserDataResult result) {
        Debug.Log("Successfully updated wallet address");
    ...
    public void SaveID() { 
        var request = new UpdateUserDataRequest {
            Data = new Dictionary<string,string> { {"WalletAddress", inputID.text.ToString()}}
        };
